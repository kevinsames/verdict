...
# ---
# title: Run Regression Detection
# description: Detects regressions between candidate and baseline model versions
# ---

# COMMAND ----------
# MAGIC %pip install /Workspace/Redict/dist/verdict-*.whl
